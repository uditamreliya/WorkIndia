 ...
 * Use the [VerticalListFragment.newInstance] factory method to
...
class VerticalListFragment : Fragment() {
    ...
    private fun startObserver() {
        ...
        viewModel.getProductList().observe(viewLifecycleOwner, Observer {
            when (it.status) {
                Status.LOADING -> {
                    binding.verticalShimmerLayout.startShimmer()
                    binding.rvVertical.visibility = View.GONE
                    binding.ivError.visibility = View.GONE
                }
                Status.SUCCESS -> {
                    binding.verticalShimmerLayout.stopShimmer()
                    binding.verticalShimmerLayout.visibility = View.GONE
    ...
    private fun setVerticalAdapter() {
        adapter = VerticalAdapter(productList)
    ...
    companion object {
         ...
         * @return A new instance of fragment VerticalListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VerticalListFragment().apply {
